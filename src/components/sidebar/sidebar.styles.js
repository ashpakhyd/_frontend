...
export const SidebarWrapper = tv({
  base: "bg-mainContainer transition-transform h-full fixed -translate-x-full w-64 shrink-0 z-[202] overflow-y-auto  flex-col py-6 px-3 md:ml-0 md:flex md:static md:h-screen md:translate-x-0 border-r-2 border-gray-1 ",
...
export const Body = tv({
  base: "flex flex-col gap-1 mt-6 px-2",
});
